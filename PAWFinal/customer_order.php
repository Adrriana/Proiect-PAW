...
<body background="product_images/descarcare.jpg">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													...
													<tr><td>Pret </td><td><b><?php echo "$ ".$row["product_price"]; ?></b></td></tr>
													<tr><td>Cantitate</td><td><b><?php echo $row["qty"]; ?></b></td></tr>
													<tr><td>Id-ul tranzactiei</td><td><b><?php echo $row["trx_id"]; ?></b></td></tr>
												</table>
											</div>
										</div>
									<?php
