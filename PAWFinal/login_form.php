...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Login - Librarie Online</title>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<form onsubmit="return false" id="login">
							...
							<p><br/></p>
							<a href="#" style="color:#333; list-style:none;">Ati uitat parola?</a><input type="submit" class="btn btn-success" style="float:right;" Value="Login">
							<!--If user dont have an account then he/she will click on create account button-->
							<div><a href="customer_registration.php?register=1">Cont nou</a></div>						
						</form>
				</div>
